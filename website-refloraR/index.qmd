...
execute:
  ...
  results: asis  # Outputs the results as-is
---
...
Today, there are **81** collections published on this platform, including:
...
![](figures/refloraR_hex_sticker.png){style="align: right;" width="300"}
:::
:::
:::
:::
