...
You can install the development version of _refloraR_ from [GitHub](https://github.com/) with:
...
## Documentation
A detailed description of the _refloraR_'s full functionality is available in 
